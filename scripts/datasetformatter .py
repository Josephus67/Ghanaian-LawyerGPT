...
Dataset formatter script for Ghanaian LawyerGPT.
Use this script to format your Ghanaian law dataset for fine-tuning.

Original script from Indian-LawyerGPT project.
"""
